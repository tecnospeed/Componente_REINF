...
Private Sub cmdConsultar_Click()
    ...
    For i = 0 To RetConsulta.Count - 1
        ...
        tbRetorno.Text = tbRetorno.Text & "      NrInsc: " & RetConsultaItem.R5001.IdeEstab.NrInsc & vbNewLine
        tbRetorno.Text = tbRetorno.Text & "      TpInsc: " & RetConsultaItem.R5001.IdeEstab.TpInsc & vbNewLine
        tbRetorno.Text = tbRetorno.Text & "      NrRecArqBase: " & RetConsultaItem.R5001.InfoTotal.NrRecArqBase & vbNewLine
            ...
            tbRetorno.Text = tbRetorno.Text & "      CNO: " & RetItemRTomR5001.CNO & vbNewLine
            ...
            tbRetorno.Text = tbRetorno.Text & "      R5011 " & vbNewLine
            tbRetorno.Text = tbRetorno.Text & "      RRecRepAD:  " & vbNewLine
            tbRetorno.Text = tbRetorno.Text & "      CRRecRepAD: " & RetItemRRecRepADR5011.CRRecRepAD & vbNewLine
            tbRetorno.Text = tbRetorno.Text & "      VlrCRRecRepAD: " & RetItemRRecRepADR5011.VlrCRRecRepAD & vbNewLine
            tbRetorno.Text = tbRetorno.Text & "      VlrCRRecRepADSusp: " & RetItemRRecRepADR5011.VlrCRRecRepADSusp & vbNewLine
            Next
            End If
