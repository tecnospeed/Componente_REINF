object fReinf: TfReinf
  Left = 686
  Top = 231
  Caption = 'TecnoSpeed - Demo Reinf - API'
  ClientHeight = 608
  ClientWidth = 540
  Color = clBtnFace
  ...
  object lbl1: TLabel
    ...
    AutoSize = False
    Caption = 
      'Essa demonstra'#231#227'o utiliza apenas Certificados A1 devidamente cad' +
      'astrados e configurados'#13#10'para um empregador em nosso portal:'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -16
    Font.Name = 'Tahoma'
